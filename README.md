...
<head>
  ...
  <!-- 如果你有自定义图标，也可以这样：
  <link rel="icon" href="https://yourdomain.com/path/to/favicon.png" type="image/png">
  -->

  <!-- Open Graph for 社交分享 -->
  <meta property="og:title" content="Chen Xin | Cellist, Composer & Music Producer">
  <meta property="og:description" content="Blending classical traditions with contemporary sounds. Explore Chen Xin's musical journey.">
  <meta property="og:image" content="https://static.readdy.ai/image/1bdd8ddb370fd7239bcf6e6f6cee28c0/8a8dac54e415eb86b6fb38e4d2978bd8.png">
  <meta property="og:url" content="https://xinc22.github.io/xchen.github.io/">
  ...
  <script>
    tailwind.config = {
      ...
      plugins: [tailwindcss, forms, typography, aspectRatio, lineClamp]
    }
  </script>
